"""Durable store for completed self-improving cycles (dep/MANIFEST.yaml's
...
(schemas/agent-cycle-report.schema.json) and a verification_record
(schemas/verification-record.schema.json), but neither phase names a
...
Not a capability: like build_catalog.py is Publish-phase tooling for the
