...
Uses rebuild_catalog (full rewalk, sample/hello_world/backend/runtime/bridge/assembler.py) since this
...
from sample.hello_world.backend.runtime.bridge.assembler import rebuild_catalog

_IMPLEMENTATION_ROOT = Path(__file__).resolve().parent
_BACKEND_ROOT = _IMPLEMENTATION_ROOT.parent
_REPO_ROOT = _BACKEND_ROOT.parent.parent.parent
