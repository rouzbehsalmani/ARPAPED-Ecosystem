"""Single request-construction point for this starter kit's app (R6).

Builds a registry and Bridge (policy/selector from starterkit/backend/runtime/bridge/MANIFEST.yaml),
...
from starterkit.backend.runtime.bridge.assembler import assemble_from_catalog
from starterkit.backend.runtime.bridge.bridge import Bridge, BridgeError
from starterkit.backend.runtime.bridge.policy import StaticPolicyEngine
from starterkit.backend.runtime.bridge.registry import CapabilityRegistry
from starterkit.backend.runtime.bridge.selector import DeterministicSelector
